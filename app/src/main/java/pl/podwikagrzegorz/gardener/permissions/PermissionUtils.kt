package pl.podwikagrzegorz.gardener.permissions
...
object PermissionUtils {
    ...
    class RationaleDialog : DialogFragment() {
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            val requestCode =
                requireArguments().getInt(ARGUMENT_PERMISSION_REQUEST_CODE)
            mFinishActivity =
                arguments?.getBoolean(ARGUMENT_FINISH_ACTIVITY) ?: true
            return AlertDialog.Builder(activity)
